        ...
        */
        ...
        toXML: function () {
            ...
            for(var row = 0, l = data.length; row < l; row++) {
                ...
                //apply row attributes (i.e. row height)
                //see http://msdn.microsoft.com/de-de/library/documentformat.openxml.spreadsheet.row(v=office.14).aspx
                if (this._rows.length > row)
                	for(var key in this._rows[row])
									    rowNode.setAttribute(key, this._rows[row][key]);
        ...
        /**
         * Expects an array of row definitions. 
         * 
         * @param {Array} Rows
         */
